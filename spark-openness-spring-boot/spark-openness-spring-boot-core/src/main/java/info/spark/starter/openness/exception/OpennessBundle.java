 ...
 * @since 1.0.0
 */
public final class OpennessBundle extends DynamicBundle {
    /**
     * BUNDLE
     */
    @NonNls
    private static final String BUNDLE = "messages.OpennessBundle";
    /**
     * INSTANCE
     */
    private static final OpennessBundle INSTANCE = new OpennessBundle();
