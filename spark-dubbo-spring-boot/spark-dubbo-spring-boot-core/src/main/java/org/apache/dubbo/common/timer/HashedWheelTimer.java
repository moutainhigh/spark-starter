...
public class HashedWheelTimer implements Timer {
    ...
    private static final int INSTANCE_COUNT_LIMIT = 128;
     ...
     *                           will result in                           {@link java.util.concurrent.RejectedExecutionException}
    ...
    public HashedWheelTimer(
        ...
        if (this.tickDuration >= Long.MAX_VALUE / this.wheel.length) {
            throw new IllegalArgumentException(String.format(
                ...
                tickDuration, Long.MAX_VALUE / this.wheel.length));
        }
    ...
    private final class Worker implements Runnable {
        ...
        public void run() {
            ...
            do {
                ...
                if (deadline > 0) {
                    ...
                    HashedWheelBucket bucket =
                        HashedWheelTimer.this.wheel[idx];
            ...
            for (; ; ) {
                HashedWheelTimeout timeout = HashedWheelTimer.this.timeouts.poll();
                if (timeout == null) {
                    break;
                }
        ...
        private void processCancelledTasks() {
            for (; ; ) {
                HashedWheelTimeout timeout = HashedWheelTimer.this.cancelledTimeouts.poll();
                if (timeout == null) {
                    // all processed
                    break;
                }
    ...
    /** isWindows */
    private static final boolean isWindows = System.getProperty("os.name", "").toLowerCase(Locale.US).contains("win");
