 ...
 */
@Slf4j
public class ErrorKafkaMqProvider extends KafkaProvier implements ErrorMqProvider {
     ...
     */
    @Override
    public void sendAsync(AbstractKafkaMessage message, @Nullable Consumer<MqResults> callback) {
        this.errorMsg();
    }
     ...
     */
    @Override
    public void sendDelayMessage(AbstractKafkaMessage message, Long time) {
        this.errorMsg();
    }
     ...
     */
    @Override
    public void sendDelayMessage(String topic, AbstractKafkaMessage message, Long time) {
        this.errorMsg();
    }
     ...
     */
    @Override
    public void delaySend(String topic, AbstractKafkaMessage message, Long time) {
        this.errorMsg();
    }
}
