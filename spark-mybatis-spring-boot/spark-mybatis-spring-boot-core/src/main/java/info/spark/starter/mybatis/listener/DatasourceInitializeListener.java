package info.spark.starter.mybatis.listener;
...
@Slf4j
@AutoListener
public class DatasourceInitializeListener implements SparkApplicationListener {
    ...
    public static final String MYBATIS_AUTOCONFIGURATION = "info.spark.starter.mybatis.autoconfigure.MybatisAutoConfiguration";
    /** Inited */
