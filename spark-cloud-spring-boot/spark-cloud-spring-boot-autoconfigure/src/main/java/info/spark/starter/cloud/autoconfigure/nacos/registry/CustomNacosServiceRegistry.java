 ...
 * @date 2022.01.21 22:04
 * @since 2022.1.1
 */
@SuppressWarnings("all")
public class CustomNacosServiceRegistry implements ServiceRegistry<Registration> {
    ...
    /** log */
    private static final Logger log = LoggerFactory.getLogger(CustomNacosServiceRegistry.class);
    ...
    /**
     * Custom nacos service registry
     *
     * @param nacosServiceManager      nacos service manager
     * @param nacosDiscoveryProperties nacos discovery properties
     * @since 2022.1.1
     */
    public CustomNacosServiceRegistry(NacosServiceManager nacosServiceManager, NacosDiscoveryProperties nacosDiscoveryProperties) {
    ...
    /**
     * Gets nacos instance from registration *
     *
     * @param registration registration
     * @return the nacos instance from registration
     * @since 2022.1.1
     */
