...
/**
 * <p>Description: info.spark.starter.log4j2 自定义插件 应用类型输出, TMS/驾驶员APP/千迅智运APP/xxxx </p>
 * {@link LogEventPatternConverter} 接口用于扩展 pattern, 类似的有 %d (时间), %C (classname) 等
 * 在 info.spark.starter.log4j2 配置 '%appType', 将会输出 AT:xxxx
 * info.spark.starter.log4j2 插件相关 {@link Plugin}
 *
 * @author dong4j
 * @version 1.2.3
...
public class ApplicationTypeConverter extends LogEventPatternConverter {
    ...
    /**
     * 必须实现 new Instance 方法, 被 info.spark.starter.log4j2 调用
     *
