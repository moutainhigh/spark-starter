...
/**
 * <p>Description: spark.logging.file 配置处理</p>
 *
 * @author dong4j
 * @version 1.0.0
...
public final class LogFileProcessor extends AbstractPropertiesProcessor {
    ...
    public void apply() {
        ...
        // spark.logging.file.max-history
