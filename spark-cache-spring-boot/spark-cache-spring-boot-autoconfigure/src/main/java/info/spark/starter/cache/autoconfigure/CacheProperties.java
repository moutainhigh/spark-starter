...
import info.spark.starter.cache.Constants;
...
public class CacheProperties {
    ...
    @Min(value = 1000, message = "至少 1000 毫秒")
    private Long cacheLockKeyExpire = Constants.DEFAULT_CACHE_LOCK_KEY_EXPIRE;
    /** Local */
    ...
    /**
         * <p>Description: 配置连接池, 需要 common-pool </p>
     *
     * @author dong4j
     * @version 1.2.4
     * @email "mailto:dong4j@gmail.com"
