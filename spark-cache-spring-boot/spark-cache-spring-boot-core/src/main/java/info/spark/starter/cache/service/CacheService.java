...
public interface CacheService {
    ...
    /** NOT_SUPPORT_MESSAGE */
    String NOT_SUPPORT_MESSAGE = "不支持的操作, 请使用 RedisCacheService";
     ...
     * @since 1.9.0
     */
    Boolean set(String key, Object value, Long time, CheckedConsumer<String> consumer, boolean checkExists);
     ...
     * @since 1.9.0
     */
    Boolean set(String key, Object value, CheckedConsumer<String> consumer, boolean checkExists);
     ...
     * @since 1.6.0
     */
    Boolean hsetAll(String key, Map<?, ?> map);
     ...
     * @since 2.0.0
     */
    Map<Object, Object> hentries(@NotNull String key);
     ...
     * @since 2.0.0
     */
    Long hincr(@NotNull String key, String field, long delta);
     ...
     * @since 2.0.0
     */
    Long hdecr(@NotNull String key, String field, long delta);
     ...
     * @since 2.1.0
     */
    default Set<Object> rangeByScore(String key, double min, double max, long offset, long count) {
